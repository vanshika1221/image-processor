...
export function sepia_image(a: number, b: number, c: number): void;
export function grayscale_image(a: number, b: number, c: number): void;
export function red_image(a: number, b: number, c: number): void;
export function green_image(a: number, b: number, c: number): void;
export function blue_image(a: number, b: number, c: number): void;
export function reset_image(a: number, b: number, c: number): void;
export function blur_image(a: number, b: number, c: number): void;
export function vertical_image(a: number, b: number, c: number): void;
export function horizontal_image(a: number, b: number, c: number): void;
